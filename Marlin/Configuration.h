...
#define STRING_CONFIG_H_AUTHOR "Vrooze" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR3EZ-BLT-UBL-LA-MPC"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.28f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2178f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0760f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0728f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 50, 200 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 9999, 9999, 999, 99999 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, -12, 0 } // vrooze - measured
...
#define X_MIN_POS -4 // Measured Min is 4 outside of bed
#define Y_MIN_POS 0 // 0 is right  on target
#define Z_MIN_POS 0
#define X_MAX_POS 243 // 243 Measured Max 
#define Y_MAX_POS Y_BED_SIZE // 231 = Measured Max
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  //#define EEPROM_INIT_NOW     // Init EEPROM on first boot after a new build. // MW - I want to keep EEPROM settings on update
#endif
