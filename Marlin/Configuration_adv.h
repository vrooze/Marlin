...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 15    // Number of iterations to apply during alignment
...
//#define ASSISTED_TRAMMING
  ...
  // Dialed in settings
  #define TRAMMING_POINT_XY { { 10, 10 }, { 203,  10 }, { 203, 218 }, { 10, 218 } }
 ...
 */
 ...
 // #define PROBING_MARGIN_FRONT 32
 // #define PROBING_MARGIN_BACK 50
#endif

#if ANY(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)
  // Override the mesh area if the automatic (max) area is too large
  //#define MESH_MIN_X 32
  //#define MESH_MIN_Y 32
  //#define MESH_MAX_X 203
  //#define MESH_MAX_Y 198
#endif
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE             27   // (mm/s) Default feedrate for retracting
